...
@Component
public class PlainClientJacksonHandler extends TextWebSocketHandler implements ApplicationListener<ApplicationReadyEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlainClientJacksonHandler.class);
    ...
    public PlainClientJacksonHandler(final PlainClientJacksonProperties clientProperties,
