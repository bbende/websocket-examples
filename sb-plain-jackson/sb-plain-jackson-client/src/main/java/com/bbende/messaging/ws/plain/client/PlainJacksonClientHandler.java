...
@Component
public class PlainJacksonClientHandler extends TextWebSocketHandler implements ApplicationListener<ApplicationReadyEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlainJacksonClientHandler.class);
    ...
    public PlainJacksonClientHandler(final PlainJacksonClientProperties clientProperties,
