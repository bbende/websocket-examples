...
@Component
public class PlainServerJacksonHandler extends TextWebSocketHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlainServerJacksonHandler.class);

    private final ObjectMapper objectMapper;
    private final Map<String, WebSocketSession> sessions = new ConcurrentHashMap<>();

    public PlainServerJacksonHandler(final ObjectMapper objectMapper) {
