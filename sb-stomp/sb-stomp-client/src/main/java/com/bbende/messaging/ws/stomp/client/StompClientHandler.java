...
@Component
public class StompClientHandler implements StompSessionHandler, ApplicationListener<ApplicationReadyEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(StompClientHandler.class);
    ...
    public StompClientHandler(final StompClientProperties clientProperties,
