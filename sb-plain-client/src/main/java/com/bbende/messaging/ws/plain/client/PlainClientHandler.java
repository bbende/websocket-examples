...
@Component
public class PlainClientHandler extends TextWebSocketHandler implements ApplicationListener<ApplicationReadyEvent> {

    private static final Logger LOGGER = LoggerFactory.getLogger(PlainClientHandler.class);
    ...
    public PlainClientHandler(final PlainClientProperties clientProperties,
